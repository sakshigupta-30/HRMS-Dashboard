...
const Sidebar = () => {
  ...
  // Define base and active classes for NavLink for readability
  ...
  return (
    <>
      <div className="w-[250px] h-screen bg-slate-800 text-slate-50 py-6 px-4 flex flex-col gap-8 sticky top-0 overflow-y-auto">

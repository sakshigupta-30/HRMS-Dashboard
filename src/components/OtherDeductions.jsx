...
const OtherDeductionsModal = ({ open, onClose, worker, onSubmit }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError("Failed to add other deductions.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                <h2 className="text-xl font-semibold mb-4">Add Other Deductions</h2>
